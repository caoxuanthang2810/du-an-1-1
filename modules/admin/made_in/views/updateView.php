    ...
    <div class="bg-white ml-[180px] w-5/6 mt-[-510px] ">
        <div class="">
            ...
            <div class="w-[400px] h-[400px] container mx-auto">
                <p class="font-semibold text-lg  mb-[20px]">Sửa xuất xứ</p>
                <form action="" method="POST" class="text-center">
                    <input type="text" name="name_made_in"
                        class="w-[400px] h-[50px] border-2 border-[#EFA969] rounded-md pl-2" value="<?php echo $made_in['name_made_in'] ?>"><br>
