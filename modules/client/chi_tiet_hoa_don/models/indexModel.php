...
function get_bills_by_id($id){
    $result = db_fetch_array("SELECT b.time,p.price as price_pro,b.price as price_bill,p.img,p.name as name_pro,d.quantily,b.code,b.status, s.name as name_status FROM `bills` b
